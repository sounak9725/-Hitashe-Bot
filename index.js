...
client.once("ready", async () => {
  ...
  await client.guilds.cache.get("827682170607763456").commands.set(fisaCommands); // guild commands for FS Automations (includes the rest of the commands)
  await client.guilds.cache.get("827682170607763456").commands.set(fisaCommands); // this should be for FSS, suman add the FSS guild id here
  ready = true;
